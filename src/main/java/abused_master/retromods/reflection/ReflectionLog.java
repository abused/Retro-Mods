package abused_master.retromods.reflection;
...
class ReflectionLog {
    ...
    private static final boolean ENABLE_LOG = Boolean.parseBoolean(System.getProperty("retromods.logReflection", "false"));
    ...
    private synchronized static String findCaller() {
        ...
        for (StackTraceElement el : stack) {
            ...
            if (!cls.startsWith("retromods.reflection.")) return cls;
        }
